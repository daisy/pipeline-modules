...
<p:declare-step xmlns:p="http://www.w3.org/ns/xproc" xmlns:d="http://www.daisy.org/ns/pipeline/data"
    ...
    xmlns:xd="http://www.daisy.org/ns/pipeline/doc" exclude-inline-prefixes="#all" version="1.0"
    type="px:mediatype-detect">
    ...
    <p:documentation xd:target="parent">
        ...
        <xd:output port="result">The same d:fileset that arrived on the input port, but with
            "media-type"-attributes added to all d:entry elements.</xd:output>
    </p:documentation>
        ...
        <p:viewport match="//d:file">
            ...
            <p:choose>
                ...
                <p:when test="$ext = 'smil'">
                    <p:add-attribute match="/*" attribute-name="media-type"
                        attribute-value="application/smil+xml"/>
                </p:when>
                <p:when test="$ext = 'mp3'">
                    <p:add-attribute match="/*" attribute-name="media-type"
                ...
                <p:when test="$ext = 'epub'">
                    <p:add-attribute match="/*" attribute-name="media-type"
                        attribute-value="application/epub+zip"/>
                </p:when>
                <p:when test="$ext = 'xpl'">
                    <p:add-attribute match="/*" attribute-name="media-type"
                ...
                <p:when test="$ext = 'xsl'">
                    <p:add-attribute match="/*" attribute-name="media-type"
                        attribute-value="application/xslt+xml"/>
                </p:when>
                ...
                <p:when test="$ext = 'mp4'">
                    <p:add-attribute match="/*" attribute-name="media-type"
                        attribute-value="audio/mpeg4-generic"/>
                </p:when>
                <p:when test="$ext = 'jpg'">
                    <p:add-attribute match="/*" attribute-name="media-type"
                ...
                <p:when test="$ext = 'dtd'">
                    <p:add-attribute match="/*" attribute-name="media-type"
                        attribute-value="application/xml-dtd"/>
                </p:when>
                <p:when test="$ext = 'res'">
                    <p:add-attribute match="/*" attribute-name="media-type"
                ...
                <p:when test="$ext = 'ogg'">
                    <p:add-attribute match="/*" attribute-name="media-type"
                        attribute-value="audio/ogg"/>
                </p:when>
                <p:when test="$ext = 'au'">
                    <p:add-attribute match="/*" attribute-name="media-type"
                        attribute-value="audio/basic"/>
                </p:when>
                <p:when test="$ext = 'snd'">
                    <p:add-attribute match="/*" attribute-name="media-type"
                        attribute-value="audio/basic"/>
                ...
                <p:when test="$ext = 'm3u'">
                    <p:add-attribute match="/*" attribute-name="media-type"
                        attribute-value="audio/x-mpegurl"/>
                </p:when>
                <p:when test="$ext = 'ra'">
                    <p:add-attribute match="/*" attribute-name="media-type"
                        attribute-value="audio/x-pn-realaudio"/>
                </p:when>
                <p:when test="$ext = 'ram'">
                    <p:add-attribute match="/*" attribute-name="media-type"
                        attribute-value="audio/x-pn-realaudio"/>
                ...
                <p:when test="$ext = 'bmp'">
                    <p:add-attribute match="/*" attribute-name="media-type"
                        attribute-value="image/bmp"/>
                </p:when>
                <p:when test="$ext = 'cod'">
                    <p:add-attribute match="/*" attribute-name="media-type"
                        attribute-value="image/cis-cod"/>
                </p:when>
                <p:when test="$ext = 'gif'">
                    <p:add-attribute match="/*" attribute-name="media-type"
                ...
                <p:when test="$ext = 'ief'">
                    <p:add-attribute match="/*" attribute-name="media-type"
                        attribute-value="image/ief"/>
                </p:when>
                <p:when test="$ext = 'jfif'">
                    <p:add-attribute match="/*" attribute-name="media-type"
                        attribute-value="image/pipeg"/>
                </p:when>
                <p:when test="$ext = 'tif'">
                    <p:add-attribute match="/*" attribute-name="media-type"
                        attribute-value="image/tiff"/>
                </p:when>
                ...
                <p:when test="$ext = 'ras'">
                    <p:add-attribute match="/*" attribute-name="media-type"
                        attribute-value="image/x-cmu-raster"/>
                </p:when>
                <p:when test="$ext = 'cmx'">
                    <p:add-attribute match="/*" attribute-name="media-type"
                        attribute-value="image/x-cmx"/>
                </p:when>
                <p:when test="$ext = 'ico'">
                    <p:add-attribute match="/*" attribute-name="media-type"
                        attribute-value="image/x-icon"/>
                </p:when>
                <p:when test="$ext = 'pnm'">
                    <p:add-attribute match="/*" attribute-name="media-type"
                ...
                <p:when test="$ext = 'rgb'">
                    <p:add-attribute match="/*" attribute-name="media-type"
                        attribute-value="image/x-rgb"/>
                </p:when>
                <p:when test="$ext = 'xbm'">
                    <p:add-attribute match="/*" attribute-name="media-type"
                        attribute-value="image/x-xbitmap"/>
                </p:when>
                <p:when test="$ext = 'xpm'">
                    <p:add-attribute match="/*" attribute-name="media-type"
                        attribute-value="image/x-xpixmap"/>
                </p:when>
                <p:when test="$ext = 'xwd'">
                    <p:add-attribute match="/*" attribute-name="media-type"
                        attribute-value="image/x-xwindowdump"/>
                </p:when>
                <p:when test="$ext = 'mp2'">
                    <p:add-attribute match="/*" attribute-name="media-type"
                        attribute-value="video/mpeg"/>
                </p:when>
                <p:when test="$ext = 'mpa'">
                    <p:add-attribute match="/*" attribute-name="media-type"
                        attribute-value="video/mpeg"/>
                ...
                <p:when test="$ext = 'mov'">
                    <p:add-attribute match="/*" attribute-name="media-type"
                        attribute-value="video/quicktime"/>
                </p:when>
                <p:when test="$ext = 'qt'">
                    <p:add-attribute match="/*" attribute-name="media-type"
                        attribute-value="video/quicktime"/>
                ...
                <p:when test="$ext = 'lsf'">
                    <p:add-attribute match="/*" attribute-name="media-type"
                        attribute-value="video/x-la-asf"/>
                </p:when>
                <p:when test="$ext = 'lsx'">
                    <p:add-attribute match="/*" attribute-name="media-type"
                        attribute-value="video/x-la-asf"/>
                ...
                <p:when test="$ext = 'asf'">
                    <p:add-attribute match="/*" attribute-name="media-type"
                        attribute-value="video/x-ms-asf"/>
                </p:when>
                <p:when test="$ext = 'asr'">
                    <p:add-attribute match="/*" attribute-name="media-type"
                        attribute-value="video/x-ms-asf"/>
                ...
                <p:when test="$ext = 'avi'">
                    <p:add-attribute match="/*" attribute-name="media-type"
                        attribute-value="video/x-msvideo"/>
                </p:when>
                <p:when test="$ext = 'movie'">
                    <p:add-attribute match="/*" attribute-name="media-type"
                        attribute-value="video/x-sgi-movie"/>
                </p:when>
                <p:when test="$ext = '323'">
                    <p:add-attribute match="/*" attribute-name="media-type"
                        attribute-value="text/h323"/>
                </p:when>
                <p:when test="$ext = 'htm'">
                    <p:add-attribute match="/*" attribute-name="media-type"
                ...
                <p:when test="$ext = 'rtx'">
                    <p:add-attribute match="/*" attribute-name="media-type"
                        attribute-value="text/richtext"/>
                </p:when>
                <p:when test="$ext = 'sct'">
                    <p:add-attribute match="/*" attribute-name="media-type"
                        attribute-value="text/scriptlet"/>
                </p:when>
                <p:when test="$ext = 'tsv'">
                    <p:add-attribute match="/*" attribute-name="media-type"
                ...
                <p:when test="$ext = 'htt'">
                    <p:add-attribute match="/*" attribute-name="media-type"
                        attribute-value="text/webviewhtml"/>
                </p:when>
                <p:when test="$ext = 'htc'">
                    <p:add-attribute match="/*" attribute-name="media-type"
                        attribute-value="text/x-component"/>
                </p:when>
                <p:when test="$ext = 'etx'">
                    <p:add-attribute match="/*" attribute-name="media-type"
                        attribute-value="text/x-setext"/>
                </p:when>
                <p:when test="$ext = 'vcf'">
                    <p:add-attribute match="/*" attribute-name="media-type"
                        attribute-value="text/x-vcard"/>
                </p:when>
                <p:when test="$ext = 'mht'">
                    <p:add-attribute match="/*" attribute-name="media-type"
                        attribute-value="message/rfc822"/>
                </p:when>
                ...
                <p:when test="$ext = 'evy'">
                    <p:add-attribute match="/*" attribute-name="media-type"
                        attribute-value="application/envoy"/>
                </p:when>
                <p:when test="$ext = 'fif'">
                    <p:add-attribute match="/*" attribute-name="media-type"
                        attribute-value="application/fractals"/>
                </p:when>
                <p:when test="$ext = 'spl'">
                    <p:add-attribute match="/*" attribute-name="media-type"
                ...
                <p:when test="$ext = 'hta'">
                    <p:add-attribute match="/*" attribute-name="media-type"
                        attribute-value="application/hta"/>
                </p:when>
                <p:when test="$ext = 'acx'">
                    <p:add-attribute match="/*" attribute-name="media-type"
                ...
                <p:when test="$ext = 'doc'">
                    <p:add-attribute match="/*" attribute-name="media-type"
                        attribute-value="application/msword"/>
                </p:when>
                <p:when test="$ext = 'dot'">
                    <p:add-attribute match="/*" attribute-name="media-type"
                        attribute-value="application/msword"/>
                ...
                <p:when test="$ext = 'oda'">
                    <p:add-attribute match="/*" attribute-name="media-type"
                        attribute-value="application/oda"/>
                </p:when>
                <p:when test="$ext = 'axs'">
                    <p:add-attribute match="/*" attribute-name="media-type"
                ...
                <p:when test="$ext = 'pdf'">
                    <p:add-attribute match="/*" attribute-name="media-type"
                        attribute-value="application/pdf"/>
                </p:when>
                <p:when test="$ext = 'prf'">
                    <p:add-attribute match="/*" attribute-name="media-type"
                ...
                <p:when test="$ext = 'p10'">
                    <p:add-attribute match="/*" attribute-name="media-type"
                        attribute-value="application/pkcs10"/>
                </p:when>
                <p:when test="$ext = 'crl'">
                    <p:add-attribute match="/*" attribute-name="media-type"
                        attribute-value="application/pkix-crl"/>
                </p:when>
                <p:when test="$ext = 'ai'">
                    <p:add-attribute match="/*" attribute-name="media-type"
                ...
                <p:when test="$ext = 'rtf'">
                    <p:add-attribute match="/*" attribute-name="media-type"
                        attribute-value="application/rtf"/>
                </p:when>
                ...
                <p:when test="$ext = 'hlp'">
                    <p:add-attribute match="/*" attribute-name="media-type"
                        attribute-value="application/winhlp"/>
                </p:when>
                <p:when test="$ext = 'bcpio'">
                    <p:add-attribute match="/*" attribute-name="media-type"
                        attribute-value="application/x-bcpio"/>
                </p:when>
                <p:when test="$ext = 'cdf'">
                    <p:add-attribute match="/*" attribute-name="media-type"
                        attribute-value="application/x-cdf"/>
                </p:when>
                <p:when test="$ext = 'z'">
                    <p:add-attribute match="/*" attribute-name="media-type"
                ...
                <p:when test="$ext = 'cpio'">
                    <p:add-attribute match="/*" attribute-name="media-type"
                        attribute-value="application/x-cpio"/>
                </p:when>
                <p:when test="$ext = 'csh'">
                    <p:add-attribute match="/*" attribute-name="media-type"
                        attribute-value="application/x-csh"/>
                </p:when>
                <p:when test="$ext = 'dcr'">
                    <p:add-attribute match="/*" attribute-name="media-type"
                ...
                <p:when test="$ext = 'dvi'">
                    <p:add-attribute match="/*" attribute-name="media-type"
                        attribute-value="application/x-dvi"/>
                </p:when>
                <p:when test="$ext = 'gtar'">
                    <p:add-attribute match="/*" attribute-name="media-type"
                        attribute-value="application/x-gtar"/>
                </p:when>
                <p:when test="$ext = 'gz'">
                    <p:add-attribute match="/*" attribute-name="media-type"
                        attribute-value="application/x-gzip"/>
                </p:when>
                <p:when test="$ext = 'hdf'">
                    <p:add-attribute match="/*" attribute-name="media-type"
                        attribute-value="application/x-hdf"/>
                </p:when>
                <p:when test="$ext = 'ins'">
                    <p:add-attribute match="/*" attribute-name="media-type"
                ...
                <p:when test="$ext = 'iii'">
                    <p:add-attribute match="/*" attribute-name="media-type"
                        attribute-value="application/x-iphone"/>
                </p:when>
                <p:when test="$ext = 'js'">
                    <p:add-attribute match="/*" attribute-name="media-type"
                ...
                <p:when test="$ext = 'latex'">
                    <p:add-attribute match="/*" attribute-name="media-type"
                        attribute-value="application/x-latex"/>
                </p:when>
                <p:when test="$ext = 'mdb'">
                    <p:add-attribute match="/*" attribute-name="media-type"
                ...
                <p:when test="$ext = 'clp'">
                    <p:add-attribute match="/*" attribute-name="media-type"
                        attribute-value="application/x-msclip"/>
                </p:when>
                <p:when test="$ext = 'dll'">
                    <p:add-attribute match="/*" attribute-name="media-type"
                ...
                <p:when test="$ext = 'cdf'">
                    <p:add-attribute match="/*" attribute-name="media-type"
                        attribute-value="application/x-netcdf"/>
                </p:when>
                <p:when test="$ext = 'nc'">
                    <p:add-attribute match="/*" attribute-name="media-type"
                        attribute-value="application/x-netcdf"/>
                ...
                <p:when test="$ext = 'p12'">
                    <p:add-attribute match="/*" attribute-name="media-type"
                        attribute-value="application/x-pkcs12"/>
                </p:when>
                <p:when test="$ext = 'pfx'">
                    <p:add-attribute match="/*" attribute-name="media-type"
                        attribute-value="application/x-pkcs12"/>
                ...
                <p:when test="$ext = 'sh'">
                    <p:add-attribute match="/*" attribute-name="media-type"
                        attribute-value="application/x-sh"/>
                </p:when>
                <p:when test="$ext = 'shar'">
                    <p:add-attribute match="/*" attribute-name="media-type"
                        attribute-value="application/x-shar"/>
                </p:when>
                <p:when test="$ext = 'swf'">
                    <p:add-attribute match="/*" attribute-name="media-type"
                ...
                <p:when test="$ext = 'sv4crc'">
                    <p:add-attribute match="/*" attribute-name="media-type"
                        attribute-value="application/x-sv4crc"/>
                </p:when>
                <p:when test="$ext = 'tar'">
                    <p:add-attribute match="/*" attribute-name="media-type"
                        attribute-value="application/x-tar"/>
                </p:when>
                <p:when test="$ext = 'tcl'">
                    <p:add-attribute match="/*" attribute-name="media-type"
                        attribute-value="application/x-tcl"/>
                </p:when>
                <p:when test="$ext = 'tex'">
                    <p:add-attribute match="/*" attribute-name="media-type"
                        attribute-value="application/x-tex"/>
                </p:when>
                ...
                <p:when test="$ext = 'roff'">
                    <p:add-attribute match="/*" attribute-name="media-type"
                        attribute-value="application/x-troff"/>
                </p:when>
                <p:when test="$ext = 't'">
                    <p:add-attribute match="/*" attribute-name="media-type"
                        attribute-value="application/x-troff"/>
                ...
                <p:when test="$ext = 'ustar'">
                    <p:add-attribute match="/*" attribute-name="media-type"
                        attribute-value="application/x-ustar"/>
                </p:when>
                <p:when test="$ext = 'src'">
                    <p:add-attribute match="/*" attribute-name="media-type"
                ...
                <p:when test="$ext = 'zip'">
                    <p:add-attribute match="/*" attribute-name="media-type"
                        attribute-value="application/zip"/>
                </p:when>
                <p:when test="$ext = 'flr'">
                    <p:add-attribute match="/*" attribute-name="media-type"
                        attribute-value="x-world/x-vrml"/>
                </p:when>
