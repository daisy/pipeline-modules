...
<p:declare-step xmlns:p="http://www.w3.org/ns/xproc" version="1.0"
    ...
    <p:choose>
        ...
        <p:otherwise>
            ...
            <p:delete>
                <p:with-option name="match"
                    select="concat(&quot;//d:file[@media-type='' or not(some $media-type-regex in tokenize('&quot;,$media-types-regexes,&quot;','[\s\t\n]+')[not(.='')] satisfies matches(@media-type,$media-type-regex))]&quot;)"
                />
            </p:delete>
        </p:otherwise>
    </p:choose>
    ...
    <p:choose>
        ...
        <p:otherwise>
            ...
            <p:delete>
                <p:with-option name="match"
                    select="concat(&quot;//d:file[not(@media-type='') and (some $not-media-type-regex in tokenize('&quot;,$not-media-types-regexes,&quot;','[\s\t\n]+')[not(.='')] satisfies matches(@media-type,$not-media-type-regex))]&quot;)"
                />
            </p:delete>
        </p:otherwise>
    </p:choose>
