...
<p:library version="1.0"
  ...
  <p:declare-step type="px:dtbook-break-detect">
    ...
    <px:break-and-reshape name="generic">
      ...
      <p:with-option name="can-contain-sentences" select="'address,author,notice,prodnote,sidebar,line,em,strong,dfn,kdb,code,samp,cite,abbr,acronym,sub,sup,span,bdo,q,p,doctitle,docauthor,levelhd,h1,h2,h3,h4,h5,h6,dt,dd,li,lic,caption,th,td,bridgehead,byline,covertitle,epigraph,dateline'"/>
