...
<p:declare-step xmlns:p="http://www.w3.org/ns/xproc" version="1.0"
    ...
    <p:input port="source.in-memory" sequence="true">
        <p:documentation xmlns="http://www.w3.org/1999/xhtml">
            <p>EPUB 3 fileset before the relocation of files.</p>
        </p:documentation>
        <p:empty/>
    </p:input>
    <p:input port="mapping">
        <p:documentation xmlns="http://www.w3.org/1999/xhtml">
            <p>A <code>d:fileset</code> document that defines the relocation of files in the EPUB 3
            fileset.</p>
        </p:documentation>
    </p:input>
    ...
    <p:import href="pub/package-doc-update-links.xpl">
        <p:documentation>
            pxi:epub3-pub-package-doc-update-links
        </p:documentation>
    </p:import>
